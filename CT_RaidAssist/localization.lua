...
L["CT_RaidAssist/Options/ClickCast/DropDownOptions"] = "#Right Click#Shift-Right Click#Alt-Right Click#Ctrl-Right Click#Disabled"
...
L["CT_RaidAssist/Options/Frames/HideBlizzardDefaultTooltip"] = "Empêche les groupes de raid par défaut d'apparaître chaque fois que des cadres CTRA personnalisés sont présents. N'a aucun effet si les trames CTRA sont désactivées. Remarque: certains autres compléments peuvent également désactiver les cadres par défaut."
