...
function StaticClickCastBroker()
	...
	local function updateSpells()
		...
		for __, details in ipairs(allBuff) do
			if (details.enabled and C_Spell.GetSpellInfo(details.name)) then
		...
		for __, details in ipairs(allRemoveDebuff) do
			if (details.enabled and C_Spell.GetSpellInfo(details.name) and (details.spec == nil or spec == nil or details.spec == spec)) then
				local key = details.button .. ", " .. details.modifier;
