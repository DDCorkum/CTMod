...
--                                            --
-- Most other raid addons will add this lib   --
-- without user concent; CTRA takes this step --
-- to prevent users from feeling mandated     --
-- into sharing private info not in the API   --
--					      --
