...
L["CT_MapMod/Options/Reset/Heading"] = "重置设置"
L["CT_MapMod/Options/Reset/Line 1"] = "注意: 这会将选项重置为默认值然后重新加载UI."
L["CT_MapMod/Options/Reset/ResetAllCheckbox"] = "重置所有角色的选项"
L["CT_MapMod/Options/Reset/ResetButton"] = "重置设置"
